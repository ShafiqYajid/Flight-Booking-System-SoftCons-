...
{        
    public ArrayList<Features> populateFeatures(Connection con)
    {
        ...
        {            
            ...
            while (rs.next())
            {
                ...
                SeatFeatures seatFeature = new SeatFeatures(newSeatPitch,newSeatWidth,newSeatType);
                TempSeat tempSeat = new TempSeat (seatPitch,seatWidth,seatType);
                Facility facility = new Facility (newVideoType,newPowerType,newWifi,newSpecialFood);
                TempFacility tempFacility = new TempFacility (videoType,powerType,wifi,specialFood);

                features.add(new Features(tempFacility,facility,tempSeat,seatFeature,price,newPrice,type,isChanged));                
            }
    ...
    public ArrayList<SeatFeatures> populateSeatFeatures(Connection con)
    {
        ArrayList<SeatFeatures> seatFeature = new ArrayList();        
        
        try
        {            
            Statement stmt = con.createStatement();
            String sql = "SELECT * FROM SeatFeatures";
            ResultSet rs = stmt.executeQuery(sql);
        ...
        //        String powerType = rs.getString("PowerType");
         ...
         //       String specialFood = rs.getString("SpecialFood");
          ...
          //      TempFacility tempFacility = new TempFacility (videoType,powerType,wifi,specialFood);
                ...
                seatFeature.add(new SeatFeatures(newSeatPitch,newSeatWidth,newSeatType));                
            }
    ...
    public ArrayList<Flight> getAllFlights(Connection con, ArrayList<Customer> customers, ArrayList<Features> features)
    {
        ...
        {            
            ...
            while (rs.next())
            {
                ...
                Flight f = new Flight(isChanged, flightName,null, totalSeats, currentSeats, departureCity, arrivalCity, departureDate, arrivalDate);
                flights.add(f);                                                
              
                
                FlightClass fC = new FlightClass(oldESeats, oldBSeats, oldFSeats, oldTSeats, economySeats, businessSeats, firstSeats);
